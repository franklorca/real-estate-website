// luminousheaven/src/app/blog/page.jsx
"use client";
      ...
      >
        <header className="mb-16 border-b border-brand-divider pb-8">
          ...
          <p className="text-brand-light font-sans text-lg md:text-xl max-w-2xl">
            Curated insights on luxury living, architectural geometry, and real
          ...
          {safeBlogs.map((blog, index) => (
            ...
            >
              <Link href={`/blog/${blog.slug}`} className="flex flex-col h-full">
                <div className="overflow-hidden aspect-[4/3] mb-6 relative bg-brand-champagne rounded">
