// luminousheaven/src/components/FeaturedListings.jsx
"use client";
...
const FeaturedListings = () => {
  ...
  const renderContent = () => {
    ...
    const heroSlug = heroProperty
      ? generateSmartSlug(heroProperty.id, heroProperty.title)
      : "";
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
        ...
        {heroProperty && (
          ...
          >
            <Link
              href={`/properties/${heroSlug}`}
              className="block w-full h-[50vh] sm:h-[600px] lg:h-full lg:min-h-[800px] overflow-hidden relative"
            >
              <Image
                ...
                className="object-cover transition-transform duration-1000 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:scale-105 opacity-90 group-hover:opacity-100"
                priority
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent pointer-events-none z-10" />
              <div className="absolute bottom-0 left-0 p-8 sm:p-12 w-full z-20">
                <p className="text-brand-champagne font-sans text-xs sm:text-sm uppercase tracking-widest mb-3 font-semibold">
