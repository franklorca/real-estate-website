// luminousheaven/src/components/Hero.jsx
"use client";
...
const Hero = () => {
  ...
  const renderCtaButton = () => {
    return (
      <Link
        href="/listings"
        className="font-sans bg-brand-accent text-white font-semibold py-3.5 px-10 rounded-sm text-[15px] uppercase tracking-[0.15em] transition-all duration-500 hover:bg-brand-accent-hover hover:shadow-[0_0_20px_rgba(197,160,89,0.4)] inline-block"
      >
        Explore Collection
      </Link>
    );
