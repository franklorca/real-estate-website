// luminousheaven/src/components/ValueProposition.jsx
"use client";
...
const ValueProposition = () => {
  return (
    <div className="bg-brand-bg py-24 sm:py-32">
        ...
        >
          {features.map((feature) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-lg shadow-sm border border-brand-divider/50"
            >
