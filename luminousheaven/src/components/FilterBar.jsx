// luminousheaven/src/components/FilterBar.jsx
"use client";
...
const FilterBar = ({ onFilterChange, initialFilters = {} }) => {
  ...
  const filterForm = (
    <form
      ...
      className="bg-white p-6 rounded-lg shadow-sm border border-brand-divider/80"
    >
    ...
    <div className="mb-10">
      <div className="lg:hidden mb-4">
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-brand-dark bg-white hover:bg-gray-50 transition-colors"
        >
          <FilterIcon />
